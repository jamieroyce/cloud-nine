<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="account.aspx.cs" Inherits="_Default" Debug="true" %>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Account Total</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
								...
								<div class="col-lg-12 ">  
									<div class="table-responsive">  
										<asp:GridView 
											...
											Visible="true"
											AllowPaging="True" 
											OnPageIndexChanging="grdData_PageIndexChanging_tot" 
											...
											<Columns>
												...
												<asp:BoundField DataField="on_account" HeaderText="On Account" SortExpression="on_account" />
												<asp:TemplateField>
													<ItemTemplate>
														<asp:LinkButton ID="lnkBtnAdd" class="btn btn-outline-info btn-sm col-12 no-print" runat="server" Text="Add To GI Lineup" OnClick="ViewAddo"></asp:LinkButton>
													</ItemTemplate>						
												</asp:TemplateField>
												<asp:TemplateField>
													<ItemTemplate>
