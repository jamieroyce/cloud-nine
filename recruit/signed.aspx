<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="signed.aspx.cs" Inherits="_Default" Debug="true" %>
											...
											<asp:GridView 
												...
												<Columns>
													...
													<asp:TemplateField Visible="true" SortExpression="Weekend" HeaderText="Date to Arrive">												
														...
														<ControlStyle width="100%" />																
													</asp:TemplateField>																<asp:TemplateField SortExpression="status" HeaderText="Status" >
														<HeaderStyle HorizontalAlign="Left" CssClass="col_med no-print" />
														<ItemTemplate>
