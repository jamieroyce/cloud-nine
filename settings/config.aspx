<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true"
	CodeFile="config.aspx.cs" Inherits="_Default" Debug="true" %>
	<%@ Register
		...
		<body class="hold-transition sidebar-mini">
			<div class="wrapper">
				...
				<aside class="main-sidebar sidebar-light-primary elevation-4">
					...
					<a href="../home.aspx" class="brand-link">
						<img src="../img/scn_sm.png" alt="Logo" class="brand-image img-circle" style="opacity: .8">
									...
									<div class="col-md-6 col-sm-6 col-12">
										<div class="card">
											...
											<div class="card-body">
												<div class="row">
													<div class="col-10">
														<b>Info:</b> Setup the Users. The first six will be used in the
														"Registrar Report".
													</div>
													<div class="col-2">
														<button type="button" id="btnAddReg" runat="server"
															class="btn btn-outline-info btn-block" data-toggle="modal"
															data-target="#addRegModal">Add</button>
													</div>
												</div>
												<div class="row">
															...
															<div class="row">
																<div class="col-lg-12 ">
																	<div class="table-responsive">
																		<asp:GridView ID="GridViewReg" runat="server"
																			AutoGenerateColumns="false"
																			DataKeyNames="id"
																			OnSorting="TaskGridView_Sorting"
																			BorderWidth="0" CellPadding="0"
																			CssClass="mGridAppt" GridLines="None"
																			Width="100%"
																			EmptyDataText="No records have been added.">
																			<Columns>
																				<asp:BoundField DataField="ID"
																					HeaderText="ID">
																					<HeaderStyle CssClass="no-display">
																					</HeaderStyle>
																					<ItemStyle CssClass="no-display">
																					</ItemStyle>
																				</asp:BoundField>
																				<asp:TemplateField visible="True"
																					...
																					<ItemTemplate>
																						<asp:DropDownList
																							id="short_name"
																							AutoPostBack="True"
																							OnSelectedIndexChanged="Selection_Change_Regno"
																							runat="server"
																							CssClass="col_xs"
																							SelectedValue='<%# Eval("short_name") %>'
																							TabIndex='<%# TabIndex %>'>
																							<asp:ListItem Value="01"> 1
																							</asp:ListItem>
																							<asp:ListItem Value="02"> 2
																							</asp:ListItem>
																							<asp:ListItem Value="03"> 3
																							</asp:ListItem>
																							<asp:ListItem Value="04"> 4
																							</asp:ListItem>
																							<asp:ListItem Value="05"> 5
																							</asp:ListItem>
																							<asp:ListItem Value="06"> 6
																							</asp:ListItem>
																							<asp:ListItem Value="07"> 7
																							</asp:ListItem>
																							<asp:ListItem Value="08"> 8
																							</asp:ListItem>
																							<asp:ListItem Value="09"> 9
																							</asp:ListItem>
																				...
																				<asp:TemplateField
																					...
																					<ItemTemplate>
																						<asp:TextBox ID="full_name"
																							AutoPostBack="True"
																							CssClass="col_med"
																							runat="server"
																							Text='<%# Eval("full_name") %>'
																							Width=150
																							OnTextChanged="text_change_reg" />
																					</ItemTemplate>
																					<ControlStyle Width="100%" />
																				</asp:TemplateField>
																				<asp:TemplateField SortExpression="area"
																					visible="True" HeaderText="Area">
																					<ItemTemplate>
																						<asp:DropDownList id="ddlArea"
																							AutoPostBack="True"
																							OnSelectedIndexChanged="Selection_Change_Area"
																							runat="server"
																							CssClass="col_xs"
																							SelectedValue='<%# Eval("area") %>'
																							TabIndex='<%# TabIndex %>'>
																							<asp:ListItem Value="">
																							</asp:ListItem>
																							<asp:ListItem Value="DIV6">
																								DIV
																								6
																							</asp:ListItem>
																							<asp:ListItem Value="DIV2">
																								DIV
																								2
																							</asp:ListItem>
																						</asp:DropDownList>
																				...
																				<asp:TemplateField>
																					<ItemTemplate>
																						<asp:LinkButton
																							ID="lnkBtnDelete"
																							class="btn btn-outline-danger btn-sm col-12 fa fa-times"
																							runat="server" Text=""
																							OnClick="DeleteRow">
																						</asp:LinkButton>
																					</ItemTemplate>
							...
							<div class="container-fluid">
									...
									<div class="col-md-6 col-sm-6 col-12">
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col-10">
														<b>Info:</b> Set the Expectancy Quotas by Area. This will be
														used in the Delivery View.
													</div>
													<div class="col-2">
														<button type="button" id="btnAddQuota" runat="server"
															class="btn btn-outline-info btn-block" data-toggle="modal"
															data-target="#addQuotaModal">Add</button>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="row">
									<div class="col-md-6 col-sm-12 col-6">
										<div class="card">
											<div class="card-body">
												<div id="gridviewQuote" runat="server">
													<div class="row">
														<div class="col-lg-12 ">
															<div class="table-responsive">
																<asp:GridView ID="GridViewExpectancy" runat="server"
																	AutoGenerateColumns="false" DataKeyNames="id"
																	OnSorting="TaskGridView_Sorting" BorderWidth="0"
																	CellPadding="0" CssClass="mGridAppt"
																	...
																	<Columns>
																		...
																		<asp:TemplateField visible="True"
																			HeaderText="RegNo">
																			<ItemTemplate>
																				<asp:DropDownList id="desc1"
																					AutoPostBack="True"
																					OnSelectedIndexChanged="Selection_Change_Desc1"
																					runat="server" CssClass="col_xs"
																					SelectedValue='<%# Eval("desc1") %>'
																					TabIndex='<%# TabIndex %>'>
																					<asp:ListItem Value="div6"> DIV6
																					</asp:ListItem>
																					<asp:ListItem Value="purif"> PURIF
																					</asp:ListItem>
																					<asp:ListItem Value="srd"> SRD
																					</asp:ListItem>
																					<asp:ListItem Value="hgc"> HGC
																					</asp:ListItem>
																					<asp:ListItem Value="acad"> ACAD
																					</asp:ListItem>
																					<asp:ListItem Value="gak"> GAK
																					</asp:ListItem>
																				</asp:DropDownList>
																			</ItemTemplate>
																			<ControlStyle Width="100%" />
																		</asp:TemplateField>
																		<asp:TemplateField SortExpression="desc2"
																			HeaderText="Quota">
																			<ItemTemplate>
																				<asp:TextBox ID="full_name"
																					AutoPostBack="True"
																					CssClass="col_med" runat="server"
																					Text='<%# Eval("desc2") %>'
																					Width=150
																					OnTextChanged="text_change_desc2" />
																			</ItemTemplate>
																			<ControlStyle Width="100%" />
																		</asp:TemplateField>
																		<asp:TemplateField>
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
									<p> Are you <b>sure</b> you want to delete this Reg from the default list? <br />
										(Graphs and Reports by Reg will only display if they are listed here).</p>
									<asp:TextBox ID="RegistrarID" type="hidden" runat="server" Text=""></asp:TextBox>
									<div class="modal-footer">
										<button type="submit" class="btn btn-default" data-dismiss="modal"
											aria-hidden="true">Close</button>
										<asp:Button ID="btnDeleteReg" OnClientClick="<% %>" class="btn btn-primary"
											runat="server" Text="Delete" CommandArgument='<%# Eval("Id") %>'
											OnCommand="btnDeleteReg_Click" />
									</div>
								</div>
							</div>
						</div><!-- /.modal-body -->
			...
			<div id="delConfQuota" class="modal fade">
				<script type="text/javascript">
					function ConfirmDeleteModal() {
						$('[id*=delConfQuota]').modal('show');
					}
				</script>
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="modal-footer">
										<button type="submit" class="btn btn-default" data-dismiss="modal"
											aria-hidden="true">Close</button>
										<asp:Button ID="btnDeleteQuota" OnClientClick="<% %>" class="btn btn-primary"
											runat="server" Text="Delete" CommandArgument='<%# Eval("Id") %>'
											OnCommand="btnDeleteQuota_Click" />
									</div>
								</div>
							</div>
						</div><!-- /.modal-body -->
			...
			<div id="addRegModal" class="modal fade" tabindex="-1" method="POST" role="dialog"
				...
				<div class="modal-dialog modal-md" role="document">
					<div class="modal-content">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										...
										<div class="col-sm-10">
											<asp:TextBox ID="regnameID" name="regnameID" runat="server" Text=""
						...
						<div class="modal-footer">
							<div class="row">
								<div class="col-md-12">
									<asp:Button ID="btnSubmitReg" OnClientClick="<% %>" class="btn btn-info"
										runat="server" Text="Save" CommandArgument='<%# Eval("Id") %>'
										OnCommand="btnAddReg_Click" />
								</div>
							</div>
						</div>
					</div>
			...
			<div id="addQuotaModal" class="modal fade" tabindex="-1" method="POST" role="dialog"
				aria-labelledby="exampleModalLabel" aria-hidden="true">
				<script type="text/javascript">
					$(document).ready(function () {
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										...
										<div class="col-sm-8">
											<asp:TextBox ID="quotaID2" name="quotaID2" runat="server" Text=""
												CssClass="form-control" style="width=100%"></asp:TextBox>
										</div>
									</div>
								</div>
