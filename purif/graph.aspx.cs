...
{  	
	...
	{ 
		...
		dt = DAL.GetOrgCategoryPieLine(OrgText.Text, "lastweek", "Purif", "Purif Start");
	...
	{ 
		...
		DataTable dt = new DataTable();
		dt = DAL.GetOrgCategoryPieLine(OrgText.Text,"thisweek", "Purif", "Purif Start");
	...
	{ 
		...
		DataTable dt = new DataTable();
		dt = DAL.GetOrgCategoryPieLine(OrgText.Text,"all", "Purif", "Purif Start");
	...
	{ 
		...
		dt = DAL.GetOrgCategoryByWeek(OrgText.Text, "Purif Start", "All", graphWeeks);
