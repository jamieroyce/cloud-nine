	...
	{				
		...
		if ( clickedButton != null)
		{
			...
			if (String.IsNullOrEmpty(scheduled)){
				...
				{
					String query = "INSERT into bis(reg_cat_id, addo_id, name, status, line, scheduled, weekend, org, notes) "
								 + "VALUES (@reg_cat_id, @addo_id, @name, @status, @line, getdate(), getdate(), @org, @notes)";
				...
				using(SqlConnection connection = databaseConnection.CreateSqlConnection())
				{
					String query = "INSERT into bis(reg_cat_id, addo_id, name, status,  line, scheduled, org, notes) "
								 + "VALUES (@reg_cat_id, @addo_id, @name, @status,  @line, @scheduled, @org, @notes)";
