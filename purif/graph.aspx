...
<head runat="server">
	...
	<title>Purif Starts Report</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Purif Starts Report</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Purif Starts Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Purif Starts By Line - Current Week</h3>
              ...
              <div class="card-body">
				...
				<shield:ShieldChart 
					...
					<PrimaryHeader Text="Starts by Line"></PrimaryHeader> 
					...
					<Axes> 
						<shield:ChartAxisX CategoricalValuesField="Line"></shield:ChartAxisX> 
						<shield:ChartAxisY></shield:ChartAxisY> 
					</Axes> 
					<DataSeries> 
						<shield:ChartPieSeries EnableValueXSorting="false" DataFieldY="Sales" DataFieldX="Line" CollectionAlias="Purif Starts">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Purif Starts - Last Week</h3>
          ...
          <div class="col-md-4">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Purif Starts By Line - All Time</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-times"></i></button>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Purif Starts ( Daily )</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-times"></i></button>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Purif Starts (
              ...
              <div class="card-body">
				<shield:ShieldChart 
					...
					<DataSeries> 
						<shield:ChartLineSeries DataFieldY="bis" CollectionAlias="Purif Starts"> 
