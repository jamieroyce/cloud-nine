					...
					<div class="card">		
						<div class="card-body">
							<div class="row">
								...
								<div class="col-3">
									<asp:TextBox ID="txtArchive" autocomplete="off"	CssClass="form-control form-control-md" runat="server"></asp:TextBox>
								</div>				
								<div class="col-3">
									<asp:TextBox ID="weText" autocomplete="off" CssClass="form-control date_we form-control-md" placeholder="Weekending:"  runat="server"></asp:TextBox>
								</div>				
								<div class="col-3">
									...
									<div class="table-responsive">  
										<asp:GridView 
											...
											<Columns>
												...
												<asp:TemplateField SortExpression="scheduled" HeaderText="BIS Date">												
													<ItemTemplate>
												...
												<asp:TemplateField SortExpression="reg_cat_id" visible="True" HeaderText="Category">
													<ItemTemplate>
														...
														CssClass="col_med" SelectedValue='<%# Eval("Reg_Cat_ID") %>' TabIndex='<%# TabIndex %>'>
															<asp:ListItem Value="Paid Start"> Paid Start </asp:ListItem>
