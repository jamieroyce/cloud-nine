<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="definite.aspx.cs" Inherits="_Default" Debug="true" %>
...
<head runat="server">
	...
	<title>Definitely Getting Done This Week</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Definite</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
					...
					<div class="card">		
						<div class="card-body">
							<div class="row">
								...
								<div class="col-6">
									<asp:TextBox ID="txt" CssClass="form-control form-control-md" runat="server"></asp:TextBox>
								</div>				
								<div class="col-2">
									<button runat="server" id="btnSearch" class="btn btn-block btn-outline-info btn-md" onserverclick="BtnSearch_Click" title="Search">
										Search
									</button>	
								</div>	
								<div class="col-2">
											...
											<Columns>
												...
												<asp:TemplateField HeaderText="Addo ID">
													...
													<asp:TemplateField SortExpression="name" HeaderText="Name">                
														<ItemTemplate>
															<asp:TextBox ID="name" CssClass="col_med" AutoPostBack="True" runat="server" Text='<%# Eval("name") %>' width="175" OnTextChanged="text_change" />
														</ItemTemplate>
													</asp:TemplateField>
													<asp:TemplateField SortExpression="amount" HeaderText="Amount">
														<ItemTemplate>
															<asp:TextBox ID="amount" CssClass="col_xs" AutoPostBack="True" CausesValidation="True" runat="server" width="75" Text='<%# Eval("amount") %>' 
																OnTextChanged="text_change" />
														</ItemTemplate>
													</asp:TemplateField>
												<asp:TemplateField SortExpression="service" HeaderText="Service">
													<ItemTemplate>
														<asp:TextBox ID="service" CssClass="col_xs" AutoPostBack="True" runat="server" width="125" Text='<%# Eval("service") %>' OnTextChanged="text_change" 
															TabIndex='<%# TabIndex %>' />
													</ItemTemplate>
												</asp:TemplateField>
												<asp:TemplateField SortExpression="reg" HeaderText="Reg">
													<ItemTemplate>
														<asp:TextBox ID="reg" CssClass="col_xs" AutoPostBack="True" runat="server" width="125" Text='<%# Eval("reg") %>' OnTextChanged="text_change" 
															TabIndex='<%# TabIndex %>' />
													</ItemTemplate>
												</asp:TemplateField>			
												<asp:TemplateField SortExpression="appt" HeaderText="Scheduled">												
													<ItemTemplate>
													<div id="appt" style="position: relative;">
														<asp:TextBox ID="appt" AutoPostBack="True" CssClass="col_small date_future" runat="server" width="75" Text='<%# Eval("appt", "{0:dd-MMM-yyyy}") %>' 
															OnTextChanged="text_change" />
													</div>
													</ItemTemplate>
												</asp:TemplateField>			
												<asp:TemplateField visible="false" SortExpression="scheduled_type" HeaderText="For" >
													<ItemTemplate>
												...
												<asp:TemplateField SortExpression="line" HeaderText="Line" >
													<ItemTemplate>
														<asp:DropDownList id="ddlLine" AutoPostBack="True" OnSelectedIndexChanged="Selection_Change_Line" runat="server" CssClass="col_small"
												...
												<asp:TemplateField visible="False" SortExpression="bird_dog" HeaderText="Bird Dog">
															<ItemTemplate>
												...
												<asp:TemplateField visible="False" SortExpression="phone" HeaderText="Phone">
															<ItemTemplate>
												...
												<asp:TemplateField SortExpression="notes" HeaderText="Notes">
															<ItemTemplate>
														<asp:TextBox ID="notes" AutoPostBack="True" CssClass="col_large" width="400" runat="server" Text='<%# Eval("notes") %>' 
															OnTextChanged="text_change" />
													</ItemTemplate>
												</asp:TemplateField>
												<asp:TemplateField SortExpression="rank" Visible="true" HeaderText="Area" >
													...
													<asp:ListItem Value="D6TR"> D6 TRNG </asp:ListItem>
													<asp:ListItem Value="D6PR"> D6 PROC </asp:ListItem>
													</asp:DropDownList>
													</ItemTemplate>
												</asp:TemplateField>												
						...
						<div class="col-md-12">
							<fieldset>
								...
								<div class="row">
									...
									<label for="bird_dogid" class="col-sm-2 control-label">FSM/Bird Dog</label>
									<div class="col-sm-6">
