<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="fppp2.aspx.cs" Inherits="_Default" Debug="true" %>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="row no-print">						
				  ...
				  <div class="col-md-2">
					<asp:LinkButton runat="server" CommandArgument="Div6Training" OnClick="LinkButton_Command">					
					<div class="small-box bg-default-gradient">
				  ...
				  <div class="col-md-2">
					<asp:LinkButton runat="server" CommandArgument="Div6Processing" OnClick="LinkButton_Command">					
					<div class="small-box bg-default-gradient">
