							...
							<div class="col-md-12">
								<fieldset>
									<div class="row">
										...
										<label class="col-sm-1 control-label" for="ddlReg_Addo">Type</label>
										<div class="col-sm-3">
											<asp:DropDownList id="ddlReg_Addo" runat="server" CssClass="form-control" 
									...
									<div class="row">
										<label for="apptid" class="col-sm-2 control-label">Scheduled</label>
										<div class="col-sm-6">
										...
										<label for="areaid" disabled="false" class="col-sm-1 control-label">Area</label>
										<div class="col-sm-3">
											<asp:DropDownList id="areaid" runat="server" CssClass="form-control"
