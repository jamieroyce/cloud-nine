										...
										<asp:GridView 
											...
											<Columns>
												...
												<asp:BoundField DataField="addo_ID">
													<HeaderStyle CssClass="no-display no-print"></HeaderStyle>
													<ItemStyle CssClass="no-display no-print"></ItemStyle>
												</asp:BoundField>  
												...
												<asp:TemplateField SortExpression="scheduled_type" HeaderText="For" >
													<ItemTemplate>
