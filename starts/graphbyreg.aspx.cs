...
{  	
	...
	{ 
		...
		reg = DAL.GetOrgReg(OrgText.Text, "name", "1");
		if(reg.Rows.Count > 0){
	...
	{ 
		...
		DataTable reg = new DataTable();
		reg = DAL.GetOrgReg(OrgText.Text, "name", "2");
	...
	{ 
		...
		DataTable reg = new DataTable();
		reg = DAL.GetOrgReg(OrgText.Text, "name", "3");
		if(reg.Rows.Count > 0){
			String regName = (String)reg.Rows[0][0];
	...
	{ 
		...
		DataTable reg = new DataTable();
		reg = DAL.GetOrgReg(OrgText.Text, "name", "4");
		if(reg.Rows.Count > 0){
			String regName = (String)reg.Rows[0][0];
	...
	{ 
		...
		DataTable reg = new DataTable();
		reg = DAL.GetOrgReg(OrgText.Text, "name", "5");
		if(reg.Rows.Count > 0){
			String regName = (String)reg.Rows[0][0];
	...
	{ 
		...
		DataTable reg = new DataTable();
		reg = DAL.GetOrgReg(OrgText.Text, "name", "6");
		if(reg.Rows.Count > 0){
			String regName = (String)reg.Rows[0][0];
