										...
										<div class="table-responsive">  
											<asp:GridView 
												...
												<Columns>
													...
													<asp:TemplateField SortExpression="appt" HeaderText="Invoice Date">												
														<ItemTemplate>
														<div id="appt" style="position: relative;">
															<asp:TextBox ID="appt" AutoPostBack="True" CssClass="col_small date_future" runat="server" Text='<%# Eval("appt", "{0:dd-MMM-yyyy}") %>' 
																OnTextChanged="text_change" />
														</div>
														</ItemTemplate>
														<ControlStyle width="100%" />																
													...
													<asp:TemplateField SortExpression="bird_dog" HeaderText="Bird Dog">
														<ItemTemplate>
															<asp:TextBox ID="bird_dog" CssClass="col_xxs" AutoPostBack="True" width="75" runat="server" Text='<%# Eval("bird_dog") %>' 
																OnTextChanged="text_change" />
														</ItemTemplate>									        		
													</asp:TemplateField>
													...
													<asp:TemplateField visible="True" HeaderText="Org">
														<ItemTemplate>
															<asp:DropDownList id="ddlOrg" AutoPostBack="True" OnSelectedIndexChanged="Selection_Change_Org" runat="server" 
																CssClass="col_small" SelectedValue='<%# Eval("org") %>' TabIndex='<%# TabIndex %>'>
																<asp:ListItem Value=""> </asp:ListItem>
													...
													<asp:TemplateField visible="False">
														<ItemTemplate>
															<asp:LinkButton ID="lnkBtnInvEdit" class="btn btn-outline-info btn-sm col-12" runat="server" Text="Edit" OnClick="DisplayInvoice"></asp:LinkButton>
														</ItemTemplate>						
													</asp:TemplateField>
													<asp:CommandField visible="False" ShowDeleteButton="False" ButtonType="Button" />
												</Columns>
											</asp:GridView>										
										</div>  
									</div>  
