...
{  	
	...
	public void StartingPage()
	{
		ErrorText.Text = "";
		Title = "Now Prospect";
		HeadText.Text = "Now Prospect";
		HeaderText.Text = "Now Prospect";
		searchText = "";
		searchCol = "";
		searchWE = "";
	...
	{				
        ...
        else if(gv.ID == "GridViewArchive"){

			
		}
		else if(gv.ID == "GridView2"){
			
			ErrorText.Text = "Make it into the GridView2 Handling Section";
