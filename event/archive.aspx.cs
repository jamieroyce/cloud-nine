...
{  	
	...
	public void StartingPage()
	{
		...
		DataGrid_Load(DAL.get_event_archive(OrgText.Text, "all", "all"), "reg");
	...
	public void Day_Click(Object sender, EventArgs e)
	{
		...
		if (searchCol=="")
			...
			DataGrid_Load(DAL.get_event_archive(OrgText.Text, searchCol), "reg");
	...
	{	
		...
		try // IN THE SHOP
		{
					  ...
					  var query = from c in dataTable.AsEnumerable() 
					   where c.Field<string>("status") == "Confirmed" && c.Field<string>("reg_cat_id") == "Archive"
					      || c.Field<string>("status") == "Reconfirmed" && c.Field<string>("reg_cat_id") == "Archive"
					      || c.Field<string>("status") == "Attended" && c.Field<string>("reg_cat_id") == "Archive"
					      || c.Field<string>("status") == "Maybe" && c.Field<string>("reg_cat_id") == "Archive"
					      || c.Field<string>("status") == "Not Coming" && c.Field<string>("reg_cat_id") == "Archive"
					      || c.Field<string>("status") == "Prospect" && c.Field<string>("reg_cat_id") == "Archive"
					  select c ;	
