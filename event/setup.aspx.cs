...
public partial class _Default : System.Web.UI.Page
{
    ...
    public void StartingPage()
    {
        ...
        GridView_Load(GridViewArchive, DAL.getArchivedEvents());
            ...
            using (SqlConnection connection = databaseConnection.CreateSqlConnection())
            {
                ...
                try
                {
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@org_id", 270);
    ...
    public void btnDeleteEvent_Click(Object sender, EventArgs e)
    {
        ...
        if (clickedButton != null)
        {
            ...
            //ADD A SECTION TO DELETE THE RECORDS FROM THE BIS TABLE AS WELL OTHERWISE THEY WILL BE ORPHANS
            GridView_Load(GridViewEvent, DAL.getEvents());
            GridView_Load(GridViewArchive, DAL.getArchivedEvents());
        }
    }
