        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="log.aspx">Event Confirms Log</a></li>
					...
					<div class="row">
						<div class="col-md-12">
							<fieldset>
								...
								<div class="row">
									<label class="col-sm-2 control-label" for="ddlReg_Addo">Select Event</label>
									<div class="col-sm-6">
										<asp:DropDownList id="ddlReg_Addo" name="ddlReg_Addo" runat="server" CssClass="form-control"></asp:DropDownList>												
									</div>
								</div>
								<div class="row">
									<label for="addo_regid" class="col-sm-2 control-label">Contacted By</label>
									<div class="col-sm-6">
										<asp:TextBox ID="addo_regid" runat="server" Text="" CssClass="form-control" ></asp:TextBox>
									</div>
