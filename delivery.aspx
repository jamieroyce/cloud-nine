<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="delivery.aspx.cs" Inherits="_Default" Debug="true" %>
...
<div class="wrapper">
	...
	<ul class="navbar-nav ml-auto">
	  ...
	  <li class="nav-item">
		<a href="settings/expectancy.aspx" class="nav-link">	  
	...
	<div class="content-wrapper">
		...
		<section class="content">
			<div class="container-fluid">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-2">
									<div class="row">
										<div class="col-12">				
											<shield:ShieldChart ID="ShieldChartDIV6" Width="100%" Height="300px" runat="server"
												OnTakeDataSource="ShieldChartDIV6_TakeDataSource"
												CssClass="chart">
												<PrimaryHeader Text="DIV6">
													<Style Bold="true" FontSize="30px" />
												</PrimaryHeader>
												<SecondaryHeader Text="Expectancy: 50 ">
												</SecondaryHeader>
									...
									<div class="float-center">
										<asp:LinkButton runat="server" CommandArgument="DIV6" OnClick="LinkButtonSignUp_Command" class="btn btn-outline-primary btn-sm" Text="Signups">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="DIV6" OnClick="LinkButtonStart_Command" class="btn btn-outline-warning btn-sm" Text="Starts">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="DIV6" OnClick="LinkButtonBIS_Command" class="btn btn-outline-danger btn-sm" Text="BIS">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="DIV6" OnClick="LinkButtonComp_Command" class="btn btn-outline-secondary btn-sm" Text="Comps">
										</asp:LinkButton>
									</div>										
									...
									<div class="col-2">
										<div class="row">
											<div class="col-12">				
												<shield:ShieldChart ID="ShieldChartPurif" Width="100%" Height="300px" runat="server"
													OnTakeDataSource="ShieldChartPurif_TakeDataSource"
													CssClass="chart">
													<PrimaryHeader Text="PURIF">
														<Style Bold="true" FontSize="30px" />
													</PrimaryHeader>
													<ExportOptions AllowExportToImage="false" AllowPrint="false" />
													<Axes>
									...
									<div class="float-center">
										<asp:LinkButton runat="server" CommandArgument="Purif" OnClick="LinkButtonSignUp_Command" class="btn btn-outline-primary btn-sm" Text="Signups">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="Purif" OnClick="LinkButtonStart_Command" class="btn btn-outline-warning btn-sm" Text="Starts">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="Purif" OnClick="LinkButtonBIS_Command" class="btn btn-outline-danger btn-sm" Text="BIS">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="Purif" OnClick="LinkButtonComp_Command" class="btn btn-outline-secondary btn-sm" Text="Comps">
										</asp:LinkButton>
									</div>										
									...
									<div class="col-2">
										<div class="row">
											<div class="col-12">				
												<shield:ShieldChart ID="ShieldChartSRD" Width="100%" Height="300px" runat="server"
													OnTakeDataSource="ShieldChartSRD_TakeDataSource"
													CssClass="chart">
													<PrimaryHeader Text="SRD"><Style Bold="true" FontSize="30px" /></PrimaryHeader>
													<ExportOptions AllowExportToImage="false" AllowPrint="false" />
													<Axes>
														<shield:ChartAxisX 
															CategoricalValuesField="Area">
									...
									<div class="float-center">
										<asp:LinkButton runat="server" CommandArgument="SRD" OnClick="LinkButtonSignUp_Command" class="btn btn-outline-primary btn-sm" Text="Signups">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="SRD" OnClick="LinkButtonStart_Command" class="btn btn-outline-warning btn-sm" Text="Starts">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="SRD" OnClick="LinkButtonBIS_Command" class="btn btn-outline-danger btn-sm" Text="BIS">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="SRD" OnClick="LinkButtonComp_Command" class="btn btn-outline-secondary btn-sm" Text="Comps">
										</asp:LinkButton>
									</div>										
									...
									<div class="col-2">
										<div class="row">
											<div class="col-12">				
												<shield:ShieldChart ID="ShieldChartHGC" Width="100%" Height="300px" runat="server"
													OnTakeDataSource="ShieldChartHGC_TakeDataSource"
													CssClass="chart">
													<PrimaryHeader Text="HGC">
														<Style Bold="true" FontSize="30px" />													
													</PrimaryHeader>
													<ExportOptions AllowExportToImage="false" AllowPrint="false" />
													<Axes>
										...
										<div class="float-center">
											<asp:LinkButton runat="server" CommandArgument="HGC" OnClick="LinkButtonSignUp_Command" class="btn btn-outline-primary btn-sm" Text="Signups">
											</asp:LinkButton>
											<asp:LinkButton runat="server" CommandArgument="HGC" OnClick="LinkButtonStart_Command" class="btn btn-outline-warning btn-sm" Text="Starts">
											</asp:LinkButton>
											<asp:LinkButton runat="server" CommandArgument="HGC" OnClick="LinkButtonBIS_Command" class="btn btn-outline-danger btn-sm" Text="BIS">
											</asp:LinkButton>
											<asp:LinkButton runat="server" CommandArgument="HGC" OnClick="LinkButtonComp_Command" class="btn btn-outline-secondary btn-sm" Text="Comps">
											</asp:LinkButton>
										</div>										
									...
									<div class="col-2">
										<div class="row">
											<div class="col-12">				
												<shield:ShieldChart ID="ShieldChartACAD" Width="100%" Height="300px" runat="server"
													OnTakeDataSource="ShieldChartACAD_TakeDataSource"
													CssClass="chart">
													<PrimaryHeader Text="ACAD"><Style Bold="true" FontSize="30px" /></PrimaryHeader>
													<ExportOptions AllowExportToImage="false" AllowPrint="false" />
													<Axes>
														<shield:ChartAxisX 
															CategoricalValuesField="Area">
									...
									<div class="float-center">
											<asp:LinkButton runat="server" CommandArgument="ACAD" OnClick="LinkButtonSignUp_Command" class="btn btn-outline-primary btn-sm" Text="Signups">
											</asp:LinkButton>
											<asp:LinkButton runat="server" CommandArgument="ACAD" OnClick="LinkButtonStart_Command" class="btn btn-outline-warning btn-sm" Text="Starts">
											</asp:LinkButton>
											<asp:LinkButton runat="server" CommandArgument="ACAD" OnClick="LinkButtonBIS_Command" class="btn btn-outline-danger btn-sm" Text="BIS">
											</asp:LinkButton>
											<asp:LinkButton runat="server" CommandArgument="ACAD" OnClick="LinkButtonComp_Command" class="btn btn-outline-secondary btn-sm" Text="Comps">
											</asp:LinkButton>
									</div>										
									...
									<div class="col-2">
										<div class="row">
											<div class="col-12">				
												<shield:ShieldChart ID="ShieldChartGAK" Width="100%" Height="300px" runat="server"
													OnTakeDataSource="ShieldChartGAK_TakeDataSource"
													CssClass="chart">
													<PrimaryHeader Text="GAK"><Style Bold="true" FontSize="30px" /> </PrimaryHeader>
													<ExportOptions AllowExportToImage="false" AllowPrint="false" />
													<Axes>
														<shield:ChartAxisX 
															CategoricalValuesField="Area">
									...
									<div class="float-center">
										<asp:LinkButton runat="server" CommandArgument="GAK" OnClick="LinkButtonSignUp_Command" class="btn btn-outline-primary btn-sm" Text="Signups">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="GAK" OnClick="LinkButtonStart_Command" class="btn btn-outline-warning btn-sm" Text="Starts">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="GAK" OnClick="LinkButtonBIS_Command" class="btn btn-outline-danger btn-sm" Text="BIS">
										</asp:LinkButton>
										<asp:LinkButton runat="server" CommandArgument="GAK" OnClick="LinkButtonComp_Command" class="btn btn-outline-secondary btn-sm" Text="Comps">
										</asp:LinkButton>
									</div>										
							...
							<div class="card-body">
								<div class="row">
									<div class="col-12">
										<div class="row">
											<div class="col-12">
												<h1 class="m-0 text-dark">Purif Starts</h1>
												<asp:Label id="OrgText8" visible="false" runat="server" Text="Combined" />												
											</div>
											<div class="col-6 text-info">
												<h5>Starts</br>
												Scheduled</br>
											...
											<div class="col-6 text-info">
												<h5><asp:Label id="ThisWeekPurif" runat="server" /></br>
												<asp:Label id="ThisWeekScheduledPurif" runat="server" /></br>
												<asp:Label id="LastWeekPurif" runat="server" /></h5>
											</div>
										</div>
										<div class="row">
											<div class="col-12">				
												<shield:ShieldChart 
												ID="ShieldChartPurif7R" 
												runat="server" AutoPostBack="true" Width="100%" Height="240px" 
												OnTakeDataSource="ShieldChartPurif7R_TakeDataSource"> 
												<PrimaryHeader Text="Daily"> 
												</PrimaryHeader> 
												<ExportOptions AllowExportToImage="false" AllowPrint="false" /> 
												<TooltipSettings CustomPointText="{point.dataSeries.collectionAlias}: <b>{point.y}</b>"></TooltipSettings> 
										...
										<div class="float-right">
											<a class="btn btn-outline-info" href="purif/graph.aspx">
											  <i class="fa fa-pie-chart text-info fa-lg"></i>
											</a>
											<a class="btn btn-outline-info" href="purif/log.aspx">
											  View Log
											</a>
										</div>										
									</div>
				...
				<p class="text-right">Public Tracking System / Version 2.0 / JSR / 24 July 2018</p>
