<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="inandstarted.aspx.cs" Inherits="_Default" Debug="true" %>
...
<head runat="server">
	...
	<title>In and Started Report</title>
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			  ...
			  <li class="nav-item">
				...
				<li class="nav-item">
					<a href="inandstarted.aspx" class="nav-link">
						<i class="fa fa-pie-chart nav-icon text-info"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">In and Started Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../home.aspx">Home</a></li>
              <li class="breadcrumb-item active">In and Started Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">In and Started By Area - Current Week</h3>
              ...
              <div class="card-body">
				...
				<shield:ShieldChart 
					...
					<DataSeries> 
						<shield:ChartPieSeries EnableValueXSorting="false" DataFieldY="Sales" DataFieldX="Area" CollectionAlias="IN AND STARTED">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">In and Started - Last Week</h3>
          ...
          <div class="col-md-4">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">In and Started By Area - All Time</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-times"></i></button>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">In and Started ( Daily )</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-times"></i></button>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">In and Started (
              ...
              <div class="card-body">
				<shield:ShieldChart 
					...
					<DataSeries> 
						<shield:ChartLineSeries DataFieldY="bis" CollectionAlias="IN AND STARTED"> 
