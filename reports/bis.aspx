<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="bis.aspx.cs" Inherits="_Default" Debug="true" %>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Bodies in the Shop Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../home.aspx">Home</a></li>
              <li class="breadcrumb-item active">BIS Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">BIS By Area - Current Week</h3>
              ...
              <div class="card-body">
				...
				<shield:ShieldChart 
					...
					<DataSeries> 
						<shield:ChartPieSeries EnableValueXSorting="false" DataFieldY="Sales" DataFieldX="Area" CollectionAlias="BIS AREA">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">BIS By Area - Last Week</h3>
          ...
          <div class="col-md-4">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Bodies in the Shop By Area - All Time</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-times"></i></button>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Bodies in the Shop ( Daily )</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-times"></i></button>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Bodies in the Shop (
              ...
              <div class="card-body">
				<shield:ShieldChart 
					...
					<PrimaryHeader Text="Bodies in the Shop"> 
					</PrimaryHeader> 
					<ExportOptions AllowExportToImage="false" AllowPrint="false" /> 
					<TooltipSettings CustomPointText="{point.dataSeries.collectionAlias}: <b>{point.y}</b>"></TooltipSettings> 
					<Axes> 
						...
						<shield:ChartAxisY min=100> 
						</shield:ChartAxisY> 
					</Axes> 
					<DataSeries> 
						<shield:ChartLineSeries DataFieldY="bis" CollectionAlias="BIS"> 
