<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="now_prospects.aspx.cs" Inherits="_Default" Debug="true" %>
					...
					<div class="card">		
						<div class="card-body">
							<div class="row">
								...
								<div class="col-2">
									<a runat="server" href="../addName.aspx" id="btnAddName" class="btn btn-block btn-info btn-md">Add Name</a>
								</div>	
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-sm-3">
									<asp:DropDownList id="addo_rankid" runat="server" CssClass="form-control"
										SelectedValue='<%# Eval("rank") %>' TabIndex='<%# TabIndex %>'>
											<asp:ListItem Value=""> - </asp:ListItem>
											<asp:ListItem Value="DIV6"> DIV6 </asp:ListItem>
											<asp:ListItem Value="Purif"> PURIF </asp:ListItem>
