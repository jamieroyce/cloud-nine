<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="fppp.aspx.cs" Inherits="_Default" Debug="true" %>
...
<head runat="server">
	...
	<title>Fully / Partially Paid</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Fully Partially Paid</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
		...
		<div class="container-fluid">
			...
			<div class="row">
					...
					<div class="card">		
						<div class="card-body">
							<div class="row">
								...
								<div class="col-2">
									<button runat="server" id="Button1" class="btn btn-block btn-outline-info btn-md" onserverclick="BtnSearch_Click_FPPP" title="Search">
										Search
									</button>							
								</div>	
							</div>
				...
				<div class="row">						
				  ...
				  <div class="col-md-2">
					<asp:LinkButton runat="server" CommandArgument="ACADEMY" OnClick="LinkButton_Command">					
					<div class="small-box bg-default-gradient">
				  ...
				  <div class="col-md-2">
					<asp:LinkButton runat="server" CommandArgument="Div 6 Training" OnClick="LinkButton_Command">					
					<div class="small-box bg-default-gradient">
					  <div id="boxDiv6Training" runat="server" class="info-box-content">
						<span class="info-box-number">DIV 6 TRAINING</span>
						<span class="info-box-text">
						</span>
						<span class="progress-description">
				  ...
				  <div class="col-md-2">
					<asp:LinkButton runat="server" CommandArgument="Div 6 Processing" OnClick="LinkButton_Command">					
					<div class="small-box bg-default-gradient">
					  <div id="boxDiv6Processing" runat="server" class="info-box-content">
						<span class="info-box-number">DIV 6 PROCESSING</span>
						<span class="info-box-text">
						</span>
						<span class="progress-description">
									...
									<div class="table-responsive">  
										<asp:GridView 
											...
											<Columns>
												...
												<asp:TemplateField>
													<ItemTemplate>
														<asp:LinkButton ID="lnkBtnAddBIS" class="btn btn-outline-success btn-sm col-12 no-print" runat="server" Text="Add To BIS Lineup" OnClick="ViewBIS"></asp:LinkButton>
													</ItemTemplate>						
												</asp:TemplateField>
											</Columns>			
										</asp:GridView>	
