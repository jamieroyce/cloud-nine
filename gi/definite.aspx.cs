...
{  	
	...
	static string vStatus = "This Week";
	...
	{
		ErrorText.Text = "";
		Title = "Definitely Getting Done";
		HeadText.Text = "Definite";
		HeaderText.Text = "Definite";
		searchText = "";
		searchCol = "";
		searchWE = "";
        ...
        DataGrid_Load(DAL.reg(vStatus, OrgText.Text), "reg");
		GridView1.Sort("status, name", SortDirection.Ascending);
    ...
    public void BtnSearch_Click(object sender, EventArgs e)
    {
		...
		searchCol = txt.Text;
		DataGrid_Load(DAL.Search(vStatus, OrgText.Text, searchText, searchCol), "reg");
    }
	...
	{	
		...
		DataRow[] dr = dataTable.Select("status = '" + vStatus + "'");			
