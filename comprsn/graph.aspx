...
<head runat="server">
	...
	<title>Comp Resign Report</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Comp Resign Report</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Comp Resign Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Comp Resign By Area - Current Week</h3>
              ...
              <div class="card-body">
				<shield:ShieldChart 
					...
					<DataSeries> 
						<shield:ChartPieSeries EnableValueXSorting="false" DataFieldY="Sales" DataFieldX="Area" CollectionAlias="COMP RESIGN">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Comp Resign - Last Week</h3>
          ...
          <div class="col-md-4">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Comp Resign By Area - All Time</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-times"></i></button>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Comp Resign ( Daily )</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-times"></i></button>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Comp Resign (
              ...
              <div class="card-body">
				<shield:ShieldChart 
					...
					<DataSeries> 
						<shield:ChartLineSeries DataFieldY="bis" CollectionAlias="COMP RESIGN"> 
