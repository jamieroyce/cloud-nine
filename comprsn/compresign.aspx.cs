...
{  	
	...
	protected void DeleteRow(object sender, EventArgs e)
	{
		...
		ErrorText.Text = "Made it into the DeleteRow() method";
	...
	{
		GridViewCompResign.PageIndex = e.NewPageIndex;
	...
	public void Archive_Click(object sender, EventArgs e)
	{
		...
		if ( clickedButton != null)
		{
			...
			int i = 0;
			GridView gv = (GridView)(sender as Control).Parent.FindControl("GridViewCompResign");		
	...
	{	
		...
		try // 
		{
			var query = from c in dataTable.AsEnumerable() 
					   where c.Field<string>("status") == "Comp Resign" && c.Field<string>("reg_cat_id") == "Comp Resign"
					  select c ;	
