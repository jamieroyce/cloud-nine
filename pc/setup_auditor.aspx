<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="setup_auditor.aspx.cs" Inherits="_Default" Debug="true" %>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Setup Auditor</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
					...
					<div class="card">		
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-2">
									<a runat="server" href="add_auditor.aspx" id="btnAddName" class="btn btn-block btn-info btn-md">Add Auditor</a>
									<br/>
								</div>
							</div>
							<div runat="server">
									...
									<div class="col-lg-12 ">  
										...
										<asp:GridView 
											...
											<Columns>					
												...
												<asp:BoundField DataField="org" visible="True" HeaderText="Org" SortExpression="org">
													<HeaderStyle HorizontalAlign="Left" CssClass="col_xs" />
												</asp:BoundField>
												<asp:TemplateField SortExpression="name" HeaderText="Name">
													<ItemTemplate>
														<asp:TextBox ID="name" AutoPostBack="True" CssClass="col_med" runat="server" Text='<%# Eval("name") %>' Width=100 OnTextChanged="text_change_auditor" />
													</ItemTemplate>
													<ControlStyle Width="100%" />								
												</asp:TemplateField>
												<asp:TemplateField SortExpression="trng_lvl" HeaderText="Training Level">
													<ItemTemplate>
														<asp:TextBox ID="trng_lvl" AutoPostBack="True" CssClass="col_med" runat="server" Text='<%# Eval("trng_lvl") %>' Width=100 OnTextChanged="text_change_auditor" />
													</ItemTemplate>
													<ControlStyle Width="100%" />								
												</asp:TemplateField>
												<asp:TemplateField SortExpression="case_lvl" HeaderText="Case Level">
													<ItemTemplate>
														<asp:TextBox ID="case_lvl" AutoPostBack="True" CssClass="col_med" runat="server" Text='<%# Eval("case_lvl") %>' Width=100 OnTextChanged="text_change_auditor" />
													</ItemTemplate>
													<ControlStyle Width="100%" />								
												</asp:TemplateField>
												<asp:TemplateField SortExpression="languages" HeaderText="Languages">
													<ItemTemplate>
														<asp:TextBox ID="languages" AutoPostBack="True" CssClass="col_med" runat="server" Text='<%# Eval("languages") %>' Width=100 OnTextChanged="text_change_auditor" />
													</ItemTemplate>
													<ControlStyle Width="100%" />								
												</asp:TemplateField>
