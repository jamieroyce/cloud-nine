<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="intheshop.aspx.cs" Inherits="_Default" Debug="true" %>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">In The Shop</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
											...
											<asp:GridView 
												...
												<Columns>
													...
													<asp:TemplateField Visible="true" SortExpression="Scheduled" HeaderText="BIS Date">												
														...
														<ItemTemplate>
															<asp:TextBox ID="scheduled" AutoPostBack="True" runat="server" class="date_thisweek col_med" Text='<%# Eval("Scheduled", "{0:dd-MMM-yyyy}") %>' Width=100 OnTextChanged="text_change" ></asp:TextBox>
														</ItemTemplate>
													</asp:TemplateField>			
													<asp:TemplateField Visible="false" HeaderText="Weekend">												
														<HeaderStyle HorizontalAlign="Left" />												
														<ItemTemplate>
															<asp:TextBox ID="weekend" AutoPostBack="True" runat="server" class="date_we col_med" Text='<%# Eval("weekend", "{0:dd-MMM-yyyy}") %>' Width=100 OnTextChanged="text_change" ></asp:TextBox>
														</ItemTemplate>
													</asp:TemplateField>			
