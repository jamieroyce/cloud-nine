<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="addCompResign.aspx.cs" Inherits="_Default" Debug="true" %>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../bis.aspx" class="nav-link">Home</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    <!-- Brand Logo -->
    <a href="../../bis.aspx" class="brand-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Comp Resign</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../bis.aspx">Home</a></li>
              <li class="breadcrumb-item active">Add Comp Resign/li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Add Comp Resign</h3>
				</div>
						...
						<div class="col-md-12">
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<asp:TextBox ID="apptid3" runat="server" Text="" CssClass="form-control" ></asp:TextBox>
									</div>
									<script type="text/javascript">
										$(function () {
