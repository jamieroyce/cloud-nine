					...
					<div class="card">		
						<div class="card-body">
							<div class="row">
								...
								<div class="col-3">
									<asp:TextBox ID="weText" CssClass="form-control date_we form-control-md" autocomplete="off" placeholder="Weekending:"  runat="server"></asp:TextBox>
								</div>				
								<div class="col-3">
...
<!-- ./wrapper -->
	...
	<script type="text/javascript">
		...
		lastdate.setDate(lastdate.getDate() - (dayOfWeek + 12 - lastdate.getDay()) % 7);		
