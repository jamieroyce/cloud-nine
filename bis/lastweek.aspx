<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="lastweek.aspx.cs" Inherits="_Default" Debug="true" %>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Last Week BIS</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
											...
											<asp:GridView 
												...
												<Columns>
													...
													<asp:TemplateField Visible="true" SortExpression="Scheduled" HeaderText="Scheduled">												
														...
														<ItemTemplate>
															<asp:TextBox ID="scheduled" AutoPostBack="True" runat="server" class="date_future col_med" Text='<%# Eval("Scheduled", "{0:dd-MMM-yyyy}") %>' Width=100 OnTextChanged="text_change" ></asp:TextBox>
														</ItemTemplate>
														<ControlStyle width="100%" />																
													</asp:TemplateField>			
