...
{  	
	...
	{ 
		...
		dt = DAL.GetOrgBISPie(OrgText.Text, "lastweek", fromWE, toWE);
	...
	{ 
		...
		DataTable dt = new DataTable();
		dt = DAL.GetOrgBISPie(OrgText.Text, "thisweek", fromWE, toWE);
	...
	{ 
		...
		DataTable dt = new DataTable();
		dt = DAL.GetOrgBISPie(OrgText.Text, "all", fromWE, toWE);
	...
	{ 
		...
		dt = DAL.GetWeeklyCategoryDistinct(OrgText.Text, "In The Shop", "All", graphWeeks);
