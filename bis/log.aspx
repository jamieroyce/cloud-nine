<!DOCTYPE html>
<%@ Page Language="C#" Trace="False" enableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="log.aspx.cs" Inherits="_Default" Debug="true" %>
								...
								<div class="col-lg-12 ">  
									...
									<asp:GridView 
										...
										<Columns>
											...
											<asp:TemplateField SortExpression="reg"  Visible="false" HeaderText="Terminal">
												<HeaderStyle HorizontalAlign="Left" CssClass="col_med" />
												<ItemTemplate>
											...
											<asp:TemplateField SortExpression="phone" HeaderText="Phone">
												<HeaderStyle HorizontalAlign="Left" CssClass="col_med" />
												<ItemTemplate>
												<asp:TextBox ID="phone" AutoPostBack="True" CssClass="col_med" runat="server" Text='<%# Eval("phone") %>' Width=120 OnTextChanged="text_change" />
												</ItemTemplate>
											</asp:TemplateField>
											...
											<asp:TemplateField>
												<ItemTemplate>
													<asp:LinkButton ID="addToGIPossible" Tooltip="Add to (Possible) GI" Class="fa fa-money text-success fa-lg" runat="server" OnClick="Click_AddToPossibleGI"></asp:LinkButton>
												</ItemTemplate>						
											</asp:TemplateField>
											<asp:TemplateField>
												<ItemTemplate>
