        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="log.aspx">In and Started Log</a></li>
              <li class="breadcrumb-item active">In and Started</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
					...
					<div class="card">		
						<div class="card-body">
							<div class="row">
								...
								<div class="col-3">
									<a runat="server" href="add.aspx" id="btnAddName" class="btn btn-block btn-info btn-md">Add Public</a>
								</div>	
							</div>
						</div>
					</div>
											...
											<asp:GridView 
												...
												<Columns>
													...
													<asp:TemplateField Visible="true" SortExpression="scheduled" HeaderText="Scheduled">												
														...
														<ItemTemplate>
															<asp:TextBox ID="scheduled" AutoPostBack="True" runat="server" class="date_thisweek col_xs_center" Text='<%# Eval("scheduled", "{0:dd-MMM-yyyy}") %>' Width=100 OnTextChanged="text_change" ></asp:TextBox>
														</ItemTemplate>														
													</asp:TemplateField>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>If you continue, all "In and Started" will be <strong>moved</strong> to "Archive"!</p>
				</div>
