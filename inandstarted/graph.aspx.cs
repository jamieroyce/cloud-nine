...
{  	
	...
	{ 
		...
		dt = DAL.GetOrgCategoryPie(OrgText.Text, "lastweek", "In and Started", "In and Started");
	...
	{ 
		...
		DataTable dt = new DataTable();
		dt = DAL.GetOrgCategoryPie(OrgText.Text,"thisweek", "In and Started", "In and Started");
	...
	{ 
		...
		DataTable dt = new DataTable();
		dt = DAL.GetOrgCategoryPie(OrgText.Text,"all", "In and Started", "In and Started");
	...
	{ 
		...
		dt = DAL.GetOrgCategoryByWeek(OrgText.Text, "In and Started", "All", graphWeeks);
	...
	{ 
		...
		dataThisWeek = DAL.GetOrgDailyCategory("thisweek", "In and Started", "In and Started", OrgText.Text);

		DataTable thisWeekSched = new DataTable();
		thisWeekSched = DAL.GetOrgDailyCategory("thisweeksched", "In and Started", "In and Started", OrgText.Text);

		DataTable dataLastWeek = new DataTable();
		dataLastWeek = DAL.GetOrgDailyCategory("lastweek", "In and Started", "In and Started", OrgText.Text);
